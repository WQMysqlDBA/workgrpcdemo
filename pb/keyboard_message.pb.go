...
const (
	...
	Keyboard_QWERTY  Keyboard_Layout = 1 //轴类型
...
type Keyboard struct {
	...
	Layout  Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=hello_grpc.Keyboard_Layout" json:"layout,omitempty"`
...
var file_keyboard_message_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x5f,
	0x67, 0x72, 0x70, 0x63, 0x22, 0x94, 0x01, 0x0a, 0x08, 0x4b, 0x65, 0x79, 0x62, 0x6f, 0x61, 0x72,
	0x64, 0x12, 0x33, 0x0a, 0x06, 0x6c, 0x61, 0x79, 0x6f, 0x75, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x1b, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x4b,
	...
	0x0a, 0x0a, 0x06, 0x41, 0x5a, 0x45, 0x52, 0x54, 0x59, 0x10, 0x03, 0x42, 0x0a, 0x5a, 0x08, 0x2e,
...
var file_keyboard_message_proto_goTypes = []interface{}{
	(Keyboard_Layout)(0), // 0: hello_grpc.Keyboard.Layout
	(*Keyboard)(nil),     // 1: hello_grpc.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: hello_grpc.Keyboard.layout:type_name -> hello_grpc.Keyboard.Layout
